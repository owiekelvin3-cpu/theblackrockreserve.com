...
export const metadata: Metadata = {
  title: "Terms of Service | Platinum Crest Bank",
  description: "Terms and conditions for using Platinum Crest Bank services.",
};
    ...
    <section className="section-padding pt-32">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <div className="space-y-6 text-text-secondary text-sm leading-relaxed">
          <p>
            By accessing or using Platinum Crest Bank, you agree to these Terms of Service.
          ...
          <p>
            To the fullest extent permitted by law, Platinum Crest Bank is not liable for indirect, incidental, or consequential damages
