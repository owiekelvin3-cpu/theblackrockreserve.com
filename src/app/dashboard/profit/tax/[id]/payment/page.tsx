...
import ProfitTaxPaymentPanel from "@/components/dashboard/ProfitTaxPaymentPanel";
import Button from "@/components/ui/Button";
import { fetchDashboardJson } from "@/lib/fetch-json";
import { useI18n } from "@/components/providers/I18nProvider";

export default function ProfitTaxPaymentPage() {
  ...
  return (
    <DashboardGate isLoading={loading}>
      {error || !data ? (
        ...
        <ProfitTaxPaymentPanel data={data} onRefresh={() => load(true)} />
      )}
    </DashboardGate>
  );
}
