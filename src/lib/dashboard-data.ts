...
import { getInvestedBalance, getProfitAvailability, getActivePendingProfitWithdrawal } from "@/lib/user-balances";
...
export async function getDashboardOverview(userId: string) {
  ...
  const [accounts, investments, recentTransactions, yearTransactions, depositSettings, investedBalance, profitAvailability, pendingProfitWithdrawal, savings] =
    await Promise.all([
      getAccounts(userId),
